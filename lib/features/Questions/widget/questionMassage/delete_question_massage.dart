...
class DeleteQuestionMassage extends StatelessWidget {
  DeleteQuestionMassage(this.text, this.id,this.removeQuestion, {super.key});
  String text;
  String id;
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () async {
                          FirebaseManger.deleteQuestion(context, id, removeQuestion);
                      },style: ElevatedButton.styleFrom(
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(20.r)
                        ),
